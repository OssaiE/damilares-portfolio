...
export default function ParticleText({
  ...
  useEffect(() => {
    ...
    const build = () => {
      ...
      // 550 (a touch lighter than bold) — the wordmark's intended display weight.
      octx.font = `550 100px "Work Sans", "Arial", sans-serif`;
      octx.letterSpacing = LETTER_SPACING;
      const label = textRef.current;
      const base = octx.measureText(label).width || 1;
      const size = (100 * W) / base;
      octx.font = `550 ${size}px "Work Sans", "Arial", sans-serif`;
      octx.letterSpacing = LETTER_SPACING;
